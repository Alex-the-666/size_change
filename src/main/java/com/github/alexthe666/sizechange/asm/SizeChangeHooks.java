...
public class SizeChangeHooks {
    ...
    public static void gluPerspective() {
       ...
       // Project.gluPerspective(getFOVModifier(LLibrary.PROXY.getPartialTicks(), true), (float)Minecraft.getMinecraft().displayWidth / (float)Minecraft.getMinecraft().displayHeight, 0.05F, farPlaneDistance * MathHelper.SQRT_2);
    }
